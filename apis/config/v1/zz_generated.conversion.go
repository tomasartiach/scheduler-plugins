...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*GreenScoreArgs)(nil), (*config.GreenScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_GreenScoreArgs_To_config_GreenScoreArgs(a.(*GreenScoreArgs), b.(*config.GreenScoreArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.GreenScoreArgs)(nil), (*GreenScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_GreenScoreArgs_To_v1_GreenScoreArgs(a.(*config.GreenScoreArgs), b.(*GreenScoreArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_GreenScoreArgs_To_config_GreenScoreArgs(in *GreenScoreArgs, out *config.GreenScoreArgs, s conversion.Scope) error {
...
// Convert_v1_GreenScoreArgs_To_config_GreenScoreArgs is an autogenerated conversion function.
func Convert_v1_GreenScoreArgs_To_config_GreenScoreArgs(in *GreenScoreArgs, out *config.GreenScoreArgs, s conversion.Scope) error {
	return autoConvert_v1_GreenScoreArgs_To_config_GreenScoreArgs(in, out, s)
}

func autoConvert_config_GreenScoreArgs_To_v1_GreenScoreArgs(in *config.GreenScoreArgs, out *GreenScoreArgs, s conversion.Scope) error {
...
// Convert_config_GreenScoreArgs_To_v1_GreenScoreArgs is an autogenerated conversion function.
func Convert_config_GreenScoreArgs_To_v1_GreenScoreArgs(in *config.GreenScoreArgs, out *GreenScoreArgs, s conversion.Scope) error {
	return autoConvert_config_GreenScoreArgs_To_v1_GreenScoreArgs(in, out, s)
}
